...
const UICtrl = (function () {
    ...
    return {
        ...
        showAlert: function (message, type) {
          ...
          const toastHTML = `<span class="alert">${message}</span>`;
          M.toast({ html: toastHTML, classes: type, displayLength: 2000 });
        },
      };
    })();
...
const App = (function () {
    ...
    const itemAddSubmit = function (e) {
        ...
        if (input.name === "" || input.money === "") {
            // alert
            UICtrl.showAlert("Please Fill All the Fields !", "red");
        } else {
    ...
    const itemDeleteSubmit = function () {
        ...
        UICtrl.clearInputState();
        // alert
        UICtrl.showAlert("Item deleted", "red");
    ...
    const clearAllSubmit = function () {
        ...
        // alert
        UICtrl.showAlert("All Items are deleted", "red");
